...
extension LocationSettingsController {
  ...
  private func addSearchInputField(_ margin: CGFloat,
                                   _ buttonWidth: CGFloat,
                                   _ navBarWidth: CGFloat,
                                   _ buttonHeight: CGFloat,
                                   _ navBar: UIView) {
    /// add textInput for search
    let searchInput = UITextField(frame: CGRect(x: (2 * margin + buttonWidth ),
                                                y: margin,
                                                width: navBarWidth - (2 * margin ) - (2 * margin ),
                                                height: buttonHeight))
    // Placeholder text
  ...
  ///   - buttonHeight: CGFloat height of buttons
  ///   - navBar: UIView NavBar container
  private func addBackButton(_ navBarWidth: CGFloat,
                             _ margin: CGFloat,
                             _ buttonWidth: CGFloat,
                             _ buttonHeight: CGFloat,
                             _ navBar: UIView) {
    ...
    // Set title font
    button.titleLabel?.font = UIFont(name: Constants.FontFamily.montserrat, size: 18)
